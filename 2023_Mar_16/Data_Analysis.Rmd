...
We used different datasets compared to the main analysis. This dataset includes estimates for previous years starting from 2005.

```{r robust_checks, include=TRUE}
...
```{r dumbell_plot, echo=FALSE}
df %>% 
  ggplot(aes(x=as.factor(Year), y=prop_pwork)) + 
  geom_line(size = 0.4, color = "grey60") +
  geom_point(aes(color = resident_type), size = 2) +
  scale_y_continuous(labels = scales::percent, limits = c(0.5,1)) +
  scale_color_manual(values = c("grey40", "orange")) + 
  labs(x = "", y = "Proportion of Residents",
       title = "Philadelphia's New Residents Have Mostly Lived and Worked Inside the City",
       subtitle = "This graph compares the proportion of new residents who live and work within Philadelphia with \nthe proportion of total residents who live and work in the city.",
       caption = "Source: Integrated Public Microdata Series (IPUMS) USA. \nAll numbers are estimates calculated from the IPUMS household survey.") +
  theme_cleveland() + 
  theme(text = element_text(family = "Georgia"),
        ...
        legend.text = element_text(family = "Georgia", color = "darkslategrey"),
        ...
        plot.caption = element_text(size = 8, margin = margin(t = 5), color = "grey50", hjust = 0),
